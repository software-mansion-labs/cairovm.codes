export const GITHUB_REPO_URL = 'https://github.com/software-mansion-labs/cairovm.codes'
...
export const CAIRO_VM_API_URL =
  process.env.NEXT_PUBLIC_CAIRO_VM_API_URL || 'wss://codeapi.starkloupe.co/ws'
